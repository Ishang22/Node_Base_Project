...
async function createTables() {
    ...
    sql = sql +'CREATE TABLE IF NOT EXISTS `variants` ( `id` bigint(20) NOT NULL AUTO_INCREMENT, `itemId` bigint(20) NOT NULL, `name` varchar(200) NOT NULL, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, KEY `name` (`name`), PRIMARY KEY (`id`) USING BTREE)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;';
    ...
    sql = sql +'CREATE TABLE IF NOT EXISTS `properties` ( `id` bigint(20) NOT NULL AUTO_INCREMENT, `size` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `clothType` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, `variantId` bigint(20) NOT NULL, `itemId` bigint(20) NOT NULL, `costPrice` float NOT NULL, `sellingPrice` float NOT NULL, `quanity` int(11) NOT NULL, PRIMARY KEY (`id`) USING BTREE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;';
    ...
    sql = sql +'CREATE TABLE IF NOT EXISTS `items` ( `id` bigint(20) NOT NULL AUTO_INCREMENT, `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `brand` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `category` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `productCode` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL, `createdAt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id`) USING BTREE, KEY `name` (`name`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;';
